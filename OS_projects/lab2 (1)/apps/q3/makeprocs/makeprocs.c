...
void main (int argc, char *argv[])
{
  ...
  for(i=0; i<numprocs; i++) {
    ...
    process_create(FILENAME_PRODUCER, h_mem_str, s_procs_completed_str, buffer_lock_str, s_fullslots_str, s_emptyslots_str, NULL);
    process_create(FILENAME_CONSUMER, h_mem_str, s_procs_completed_str, buffer_lock_str, s_fullslots_str, s_emptyslots_str, NULL);
