...
* FILE: hw7_sendrec.c
* DESCRIPTION:
*   Sums an array of elements using mpi send and receive
* AUTHOR: Nathan Tornquist 2/24
* LAST REVISED: 02/24/15
*
* Compile the program:
* mpicc hw7_sendrec.c -o hw7_sendrec
*
* Execute the program:
* qsub -l nodes=1:ppn=16,walltime=00:01:00 ./hw7_sendrec.sub
******************************************************************************/
#include <mpi.h>
#include <stdio.h>
#include <stdbool.h>
...
int main (int argc, char *argv[])
{
  ...
  if (rank == MASTER){
    ...
    MPI_Send(&localsum, 1, MPI_DOUBLE, MASTER, tag, MPI_COMM_WORLD);
  }
